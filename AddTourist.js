...
const AddTourist = () => {
	...
	let handleSubmit = (event) => {
		...
		axios
			.post('http://localhost:8080/safari/booking/createBooking/tour/' + tourId + '/user/' + user, requestObject)
			//.post('http://localhost:8080/api/book/user/2/train/' + selectedTrain + '/addBooking/', requestObject)
			//.post('http://localhost:8080/api/passenger/addPassenger', formValues)
			.then((response) => {
